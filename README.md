...
Aprender e praticar layout com CSS de forma interativa e responsiva.

A ideia é recriar uma card (estilo pokémon?) sobre algum personagem. Escolhi Frieren de Sousou no Frieren. Editei o nome principal e os atributos para ficar mais bacana.

As tags do HTML permanecem originais.

Background vai ser um azul leve, alguns detalhes em roxo e amarelo.
